	...
	write_doctype(
		...
		"ic_laboratory_test_scope",
		{
			...
			"fields": [
				...
				field(fieldname="purchase_price", fieldtype="Currency", label="Purchase Price", in_list_view=1,
					permlevel=1, description="Admin only"),
				field(fieldname="selling_price", fieldtype="Currency", label="Selling Price", in_list_view=1),
				field(fieldname="margin", fieldtype="Currency", label="Margin", in_list_view=1, permlevel=1,
					read_only=1, description="Admin only"),
	...
	write_doctype(
		...
		"ic_settings",
		{
			...
			"fields": [
				...
				field(fieldname="primary_color", fieldtype="Color", label="Primary Color", default="#065175"),
				field(fieldname="accent_color", fieldtype="Color", label="Accent Color", default="#EC6820"),
				field(fieldname="column_break_1", fieldtype="Column Break"),
